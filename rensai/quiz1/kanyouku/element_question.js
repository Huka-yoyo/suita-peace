(function ($) {
  ...
  const prefecturalCapital = [
    {
      id: "01",
      question: "「万物が自然の本性に従って、自由に楽しんでいることのたとえ。また、そのような天の理の作用のこと。」という意味を持つ四字熟語とは何か？",
      answer01: "鳶飛魚躍(えんぴぎょやく)",
      answer02: "安穏無事(あんのんぶじ)",
      answer03: "安寧秩序(あんねいちつじょ)",
      answer04: "偃武修文(えんぶしゅうぶん)",
    },
  ];
//  -----------------------------------------------------------------------------------------------------------------
